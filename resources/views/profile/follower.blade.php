...
@section('content')
    ...
    <div class="userHome_layoutDiv">
        ...
        <div class="userHome_layoutDivContent profile_bottom_content" id="follower_content">

        </div>
        <div class="text-center" id="follower_nav">
...
@section('javascript')
    <script type="text/javascript">
        $(function() {
            showFollowFollowerPage('follower', 'follower', '{{ $user->url_name }}', 1, null);
        });
    </script>
@endsection