            ...
            <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" emb-background-style>
                ...
                <div class="column" style='text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;Margin-bottom: 24px;">
                        ...
                        <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">We've detected that you used NUS IVLE to log in. It's perfect and recommended.</h3><h3 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">However, if you prefer using the email and password to log in, you may do so using the following credentials.</h3><ul style="Margin-top: 12px;Margin-bottom: 0;Margin-left: 24px;padding: 0;list-style-type: disc;"><li style="Margin-top: 12px;Margin-bottom: 0;Margin-left: 0;"><h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">Email :&nbsp; {{ $user->email }}</h3></li><li style="Margin-top: 0;Margin-bottom: 0;Margin-left: 0;"><h3 style="Margin-top: 0;Margin-bottom:
    0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">Temporary Password : {{ md5($user->id . env('APP_KEY')) }}</h3>
                                <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">Change your password <a style="text-decoration: none;transition: opacity 0.1s ease-in;color: #5c91ad;" href="{{ action('SettingsController@getAccount') }}">here</a>.</h3>
                            </li></ul>
                    </div>
        ...
        <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
            <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" emb-background-style>
                ...
                <div class="column" style='text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;Margin-bottom: 24px;">
                        <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">As NUS Ding is a helpful and real society, it is important to ensure that users are real people (not robot).</h3><h3 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">Currently, it is required that every account should be  associated with an NUS IVLE Account for our identification.</h3><h3 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">Please <a style="text-decoration: none;transition: opacity 0.1s ease-in;color: #5c91ad;" href="{{ action('SettingsController@getAccount') }}">bind</a>
                            your IVLE account here for more privileges in using NUS Ding.</h3><h3 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">Thank you.</h3>
                    </div>
            ...
            <div class="column wide" style='text-align: left;font-size: 12px;line-height: 19px;color: #b9b9b9;font-family: "Open Sans",sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);'>
                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                    ...
                    <div style="Margin-top: 18px;">
                        <div>You are receiving this email because you have registered on NUS Ding.<br />
