...
<div class="wrapper" style="min-width: 320px;background-color: #f5f7fa;" lang="x-wrapper">
    <div class="preheader" style="Margin: 0 auto;max-width: 560px;min-width: 280px; width: 280px;width: calc(28000% - 173040px);">
        <div style="border-collapse: collapse;display: table;width: 100%;">
            ...
            <div class="snippet" style='Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #b9b9b9;font-family: "Open Sans",sans-serif;'>

            </div>
            <!--[if (mso)|(IE)]></td><td style="width: 280px" valign="top"><![endif]-->
            <div class="webversion" style='Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 10px 0 5px 0;text-align: right;color: #b9b9b9;font-family: "Open Sans",sans-serif;'>
    ...
    <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);" id="emb-email-header-container">
        ...
        <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
            <div class="logo-center" style="font-size:0px !important;line-height:0 !important;" align="center" id="emb-email-header"><img style="height: auto;width: 100%;border: 0;max-width: 160px;" src="{{ asset('static/images/ding-logo.png') }}" alt="" width="160" /></div>
        </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
    </div>
        ...
        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" emb-background-style>
            ...
            <div class="column" style='text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
                    ...
                    <h2 class="size-24" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #44a8c7;font-size: 20px;line-height: 28px;text-align: center;" lang="x-size-24"><strong>Welcome {{ $user->name }},</strong></h2><p class="size-16" style="Margin-top: 16px;Margin-bottom: 0;font-size: 16px;line-height: 24px;text-align: left;" lang="x-size-16">Hi, {{$user->name}}, Thank you for registering NUSDing. Hope you have a greate experience in using NUSDing.</p><p class="size-16" style="Margin-top: 20px;Margin-bottom: 0;font-size: 16px;line-height: 24px;text-align: left;" lang="x-size-16">You may find the following link useful:</p><ul style="Margin-top: 20px;Margin-bottom: 0;Margin-left: 24px;padding: 0;list-style-type: disc;"><li class="size-16" style="Margin-top: 20px;Margin-bottom: 0;Margin-left: 0;font-size: 16px;line-height: 24px;text-align: left;" lang="x-size-16"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #5c91ad;" href="http://blog.nusding.info/index.php/2016/07/23/how-to-use-nusding/">How to use NUSDing?</a></li><li class="size-16" style="Margin-top: 0;Margin-bottom: 0;Margin-left: 0;font-size: 16px;line-height: 24px;text-align: left;" lang="x-size-16"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #5c91ad;" href="http://blog.nusding.info/index.php/2016/07/23/how-can-i-level-up/">How to level up?</a></li><li class="size-16" style="Margin-top: 0;Margin-bottom: 0;Margin-left: 0;font-size: 16px;line-height: 24px;text-align: left;" lang="x-size-16"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #5c91ad;" href="http://blog.nusding.info/index.php/2016/07/22/how-to-post-a-good-question/">How to post a good question?</a></li></ul><p class="size-16" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 16px;line-height: 24px;text-align: left;" lang="x-size-16">Additionally, we recommend you to update your profile.</p>
                </div>

                <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                    <div class="btn btn--flat fullwidth btn--large" style="text-align: center;">
                        <![if !mso]><a style='border-radius: 4px;display: block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #fff;background-color: #44a8c7; color: #f5f7fa; font-family: &#39;Open Sans&#39;, sans-serif !important;font-family: "Open Sans",sans-serif;' href="http://nusding.info/people/edit">Update my profile</a><![endif]>
                        <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://nusding.info/people/edit" style="width:560px" arcsize="9%" fillcolor="#44A8C7" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#F5F7FA;font-family:sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">Update my profile</center></v:textbox></v:roundrect><![endif]--></div>
                </div>
            ...
            <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" emb-background-style>
                ...
                <div class="column" style='text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;Margin-bottom: 24px;">
                        ...
                        <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">We detect that you are using NUS IVLE to login in. It's perfect and recommended.</h3><h3 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">However, if you prefer using the email and password to login in, we &nbsp;also provide you username and password here.</h3><ul style="Margin-top: 12px;Margin-bottom: 0;Margin-left: 24px;padding: 0;list-style-type: disc;"><li style="Margin-top: 12px;Margin-bottom: 0;Margin-left: 0;"><h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">Email :&nbsp; {{ $user->email }}</h3></li><li style="Margin-top: 0;Margin-bottom: 0;Margin-left: 0;"><h3 style="Margin-top: 0;Margin-bottom:
    0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">Password : {{ md5($user->id . env('APP_KEY')) }}</h3>
                                <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">You can change your password <a style="text-decoration: none;transition: opacity 0.1s ease-in;color: #5c91ad;" href="{{ action('SettingsController@getAccount') }}">here</a>.</h3>
                            </li></ul>
                    </div>
        ...
        <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
            <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" emb-background-style>
                ...
                <div class="column" style='text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;Margin-bottom: 24px;">
                        <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">We would like to remind you that NUSDing is a helpful community and we expect everyone to be a real people (not a robot).</h3><h3 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">Currently, we required every account to associate with an NUS IVLE id for our identification.</h3><h3 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">Please <a style="text-decoration: none;transition: opacity 0.1s ease-in;color: #5c91ad;" href="{{ action('SettingsController@getAccount') }}">bind</a>
                            your IVLE id here for more privilages in using NUSDing.</h3><h3 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #434547;font-size: 16px;line-height: 24px;">Thank you.</h3>
                    </div>
            ...
            <div class="column wide" style='text-align: left;font-size: 12px;line-height: 19px;color: #b9b9b9;font-family: "Open Sans",sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);'>
                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                    ...
                    <div style="Margin-top: 18px;">
                        <div>You are receiving this email because you are trying to register NUSDing.<br />
    ...
    <div class="layout one-col email-footer" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
            ...
            <div class="column" style='text-align: left;font-size: 12px;line-height: 19px;color: #b9b9b9;font-family: "Open Sans",sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                    <div>
                        <a style="text-decoration: none;transition: opacity 0.1s ease-in;color: #5c91ad;" href="{{ action('SettingsController@getNotification') }}">Unsubscribe</a>
                    </div>
                </div>
            </div>
            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
